...
import { downloadKenaikanBerkala } from "./action";
import { base64toBlob } from "@helpers/string";
import { LoadingButtonClient } from "@components/builder/loading-button-client";
import TooltipBuilder from "@components/builder/tooltip";
import { FileSpreadsheetIcon } from "lucide-react";

const KenaikanBerkalaDownloadButton = ({filter}:{filter:string}) => {
    const downloadFile = useMutation({
		mutationFn: downloadKenaikanBerkala,
		onSuccess: (data) => {
...
export default KenaikanBerkalaDownloadButton;