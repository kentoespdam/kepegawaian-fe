"use client"
import { findStatusKerjaValue, type StatusKerja } from "@_types/master/status_kerja";
...
const SelectStatusKerjaZod = <TData extends FieldValues>({ id, label, form }: InputZodProps<TData>) => {
                                ...
                                >
                                    {!query.data ?
                                        ...
                                        query.isLoading || query.isFetching ?
                                            "Loading..." :
                                            field.value ?
                                                findStatusKerjaValue(query.data ?? [], field.value).nama :
                                                "Pilih Status Kerja"}
                                ...
                                <CommandList>
                                    ...
                                    {query.data?.map((status_kerja) => (
                                        <CommandItem
                                            ...
                                            onSelect={() => {
                                                field.onChange(String(status_kerja.id))
                                                setPop(false)
                                            }}
                                        >
                                            {status_kerja.nama}
