...
const OrganisasiFormComponent = ({ data }: OrganisasiFormComponentProps) => {
    ...
    const { defaultValues, setDefaultValues } = useOrganisasiStore((state) => ({
        ...
        <Form {...form}>
            <form name="form" onSubmit={form.handleSubmit(onSubmit)}
                ...
                <div className="mt-2 flex gap-2 justify-end">
                    ...
                    <TooltipBuilder text="Batal" delayDuration={100} className="bg-destructive text-destructive-foreground">
