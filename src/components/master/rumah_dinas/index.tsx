...
import {
	type RumahDinas,
	rumahDinasTableColumns,
} from "@_types/master/rumah_dinas";
...
const RumahDinasComponent = () => {
	...
	const { rumahDinasId, openDelete, setOpenDelete } = useRumahDinasStore(
		(state) => ({
	...
	const { isLoading, error, data } = useQuery({
		...
		queryFn: async () =>
			await getPageDataEnc<RumahDinas>({
				path: encodeString("rumah_dinas"),
