...
const ApprovalCellGrouped = ({
	...
	return (
		<>
			...
			<TableRow key={`total-${organisasi.id}`} className="bg-lime-100 font-bold">
				<TableCell colSpan={2}>&nbsp;</TableCell>
				<TableCell>
					Total : {gajiBatchMasters?.length ?? 0} Pegawai
				</TableCell>
				<TableCell>&nbsp;</TableCell>
                ...
                <TableCell align="right" className="border-x">
                    {rupiah(
                        gajiBatchMasters?.reduce((a, b) => a + b.pembulatan, 0) ?? 0,
                    )}
                </TableCell>
                <TableCell align="right" className="border-x">
                    {rupiah(
                ...
                <TableCell align="right" className="border-x">
                    {rupiah(
                        gajiBatchMasters?.reduce((a, b) => a + b.penghasilanBersihFinal2, 0) ?? 0,
                    )}
                </TableCell>
			</TableRow>
		</>
