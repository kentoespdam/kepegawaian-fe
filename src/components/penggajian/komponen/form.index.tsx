...
const KomponenGajiFormComponent = ({
	availableCode,
	profilGaji,
	urut,
	komponenGaji,
}: KomponenGajiFormComponentProps) => {
	const { defaultValues, setDefaultValues } = useKomponenGajiStore();
	...
	}, [setDefaultValues, profilGaji, urut, komponenGaji]);
