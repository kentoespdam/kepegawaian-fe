...
const VerifPhase2MainFilter = ({ pegawai, gajiBatchRoot }: VerifPhase2MainFilterProps) => {
    ...
    const rootBatchId = gajiBatchRoot.empty ? "" : gajiBatchRoot.content[0].batchId
    const disableVerifAndDownload = gajiBatchRoot.empty
    const disableVerif = gajiBatchRoot.empty ? true :
        ...
        <Form {...form}>
            <div className="flex justify-center items-center gap-2">
                ...
                <form
                    ...
                    <TooltipBuilder text="Proses Ulang" className="bg-destructive text-destructive-foreground" delayDuration={10}>
                        <Button type="submit" variant="destructive" className="flex gap-2 mt-2"
                            disabled={disableVerifAndDownload || disableVerif}
