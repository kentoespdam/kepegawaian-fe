...
const VerifPhase2Component = ({ pegawai, organisasiList, gajiBatchMasters }: VerifPhase2ComponentProps) => {
        ...
        <div className="grid gap-2 pr-4" >
            <div>
                <h2 className="flex">
                    ...
                    Tambah Komponen Gaji [Periode <span className="ml-2 text-primary">{getNamaBulan(Number(bulan))} {tahun}</span>]
                </h2>
            </div>
