...
interface LampiranSpDetailComponentProps {
	id: number;
}
const LampiranSpDetailComponent = ({ id }: LampiranSpDetailComponentProps) => {
	const query = useQuery<LampiranFile>({
		queryKey: ["lampiran-sp", id],
...
export default LampiranSpDetailComponent;
