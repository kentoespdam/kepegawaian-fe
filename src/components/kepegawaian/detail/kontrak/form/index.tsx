...
import { RiwayatKontrakSchema } from "@_types/kepegawaian/riwayat_kontrak";
...
const RiwayatKontrakFormComponent = ({ pegawaiId }: { pegawaiId: number }) => {
	const { defaultValues, jenisKontrak } = useRiwayatKontrakStore((state) => ({
