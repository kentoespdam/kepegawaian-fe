...
const CvComponent = ({ pegawaiId }: { pegawaiId: number }) => {
	const {
		data: pegawai,
		isLoading,
		isFetching,
	...
	return !pegawai || isLoading || isFetching ? null : (
		<div className="w-full grid grid-cols-12">
			<div className="grid col-span-4 border p-4 gap-4 bg-gray-800 text-white">
			...
			<div className="col-span-8 border p-1">
