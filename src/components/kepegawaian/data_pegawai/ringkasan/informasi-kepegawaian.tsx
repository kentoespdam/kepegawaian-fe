...
const InformasiKepegawaian = ({ pegawai }: InformasiKepegawaianProps) => {
	...
	const absensiId = pegawai?.absensiId ?? 0
	const idAbsensi = absensiId > 0 ? absensiId.toString() : "-"
	return (
		<Fieldset title="Informasi Kepegawaian">
			<div className="grid w-full gap-1">
				<RingkasanContent
					field="Status"
					value={pegawai?.statusPegawai}
				/>
				<RingkasanContent
				...
				<RingkasanContent
					field="TMT Golongan"
					value={pegawai?.tmtGolongan}
				/>
				<RingkasanContent
					field="Masa Kerja Golongan"
					value={pegawai?.tmtGolongan}
				/>
				<RingkasanContent
					field="Unit Kerja"
				...
				<RingkasanContent
					field="Tgl. Mulai Kerja"
					value={pegawai?.tmtKerja}
				/>
				<RingkasanContent
					field="Tgl. Pengangkatan"
					value={pegawai?.tmtPegawai}
				/>
				<RingkasanContent
					field="TMT Pensiun"
					value={pegawai?.tmtPensiun}
				/>
				<RingkasanContent
					field="Status BPJS Kesehatan"
					value={isAskes}
				/>
				<RingkasanContent field="ID Mesin Absen" value={idAbsensi} />
				<RingkasanContent
					field="No Kontrak"
					value={pegawai?.noKontrak}
				/>
				<RingkasanContent field="No NPWP" value={pegawai?.noNpwp} />
				<RingkasanContent
					field="No Jamsostek"
					value={pegawai?.noJamsostek}
				/>
