 ...
 * Endpoint : DELETE /system/roles/{roleId}/permissions/{permName}, GET /system/roles, GET /system/roles/list, GET /system/roles/{id}, POST /system/roles, POST /system/roles/{roleId}/permissions/{permName}
 */
