...
export const STATUS_BADGE: Record<StatusBatch, string> = {
	PENDING:
		"bg-amber-100 text-amber-800 border-amber-300/60 dark:bg-amber-950/50 dark:text-amber-300 dark:border-amber-800",
	...
	WAIT_VERIFICATION_PHASE_1:
		"bg-purple-100 text-purple-800 border-purple-300/60 dark:bg-purple-950/50 dark:text-purple-300 dark:border-purple-800",
	WAIT_VERIFICATION_PHASE_2:
		"bg-violet-100 text-violet-800 border-violet-300/60 dark:bg-violet-950/50 dark:text-violet-300 dark:border-violet-800",
	WAIT_APPROVAL:
		"bg-orange-100 text-orange-800 border-orange-300/60 dark:bg-orange-950/50 dark:text-orange-300 dark:border-orange-800",
	FINISHED:
		"bg-emerald-100 text-emerald-800 border-emerald-300/60 dark:bg-emerald-950/50 dark:text-emerald-300 dark:border-emerald-800",
