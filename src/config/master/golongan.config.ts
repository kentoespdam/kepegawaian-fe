import { z } from "zod";
import type { GolonganPostRequest, GolonganQuery } from "@/types/master/golongan";
import { type EntityConfig, makeConfig, namaWajib } from "./_config-kit";

export const golonganConfig: EntityConfig<GolonganQuery, GolonganPostRequest> = makeConfig<
	GolonganQuery,
	GolonganPostRequest
>(
