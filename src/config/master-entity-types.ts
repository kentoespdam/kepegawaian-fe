...
import type { AlasanBerhentiListResponse, AlasanBerhentiPostRequest, AlasanBerhentiQuery } from "@/types/master/alasan-berhenti";
...
import type { JenisKeahlianListResponse, JenisKeahlianPostRequest, JenisKeahlianQuery } from "@/types/master/jenis-keahlian";
import type { JenisKitasListResponse, JenisKitasPostRequest, JenisKitasQuery } from "@/types/master/jenis-kitas";
import type { JenisPelatihanListResponse, JenisPelatihanPostRequest, JenisPelatihanQuery } from "@/types/master/jenis-pelatihan";
...
export interface MasterEntityTypes {
  golongan: { TItem: GolonganQuery; TPage: Page<GolonganQuery>; TReq: GolonganPostRequest; TList: GolonganListResponse[] };
  level: { TItem: LevelResponse; TPage: Page<LevelResponse>; TReq: LevelPostRequest; TList: LevelResponse[] };
  "jenjang-pendidikan": { TItem: JenjangPendidikanResponse; TPage: Page<JenjangPendidikanResponse>; TReq: JenjangPendidikanPostRequest; TList: JenjangPendidikanResponse[] };
  "jenis-keahlian": { TItem: JenisKeahlianQuery; TPage: Page<JenisKeahlianQuery>; TReq: JenisKeahlianPostRequest; TList: JenisKeahlianListResponse[] };
  "jenis-pelatihan": { TItem: JenisPelatihanQuery; TPage: Page<JenisPelatihanQuery>; TReq: JenisPelatihanPostRequest; TList: JenisPelatihanListResponse[] };
  "jenis-kitas": { TItem: JenisKitasQuery; TPage: Page<JenisKitasQuery>; TReq: JenisKitasPostRequest; TList: JenisKitasListResponse[] };
  "jenis-sp": { TItem: JenisSpQuery; TPage: Page<JenisSpQuery>; TReq: JenisSpPostRequest; TList: JenisSpListResponse[] };
  "alasan-berhenti": { TItem: AlasanBerhentiQuery; TPage: Page<AlasanBerhentiQuery>; TReq: AlasanBerhentiPostRequest; TList: AlasanBerhentiListResponse[] };
  "hari-libur": { TItem: HariLiburQuery; TPage: Page<HariLiburQuery>; TReq: HariLiburPostRequest; TList: HariLiburListResponse[] };
  "rumah-dinas": { TItem: RumahDinasQuery; TPage: Page<RumahDinasQuery>; TReq: RumahDinasPostRequest; TList: RumahDinasListResponse[] };
  organisasi: { TItem: OrganisasiQuery; TPage: Page<OrganisasiQuery>; TReq: OrganisasiPostRequest; TList: OrganisasiListResponse[] };
  ...
  "alat-kerja": { TItem: AlatKerjaQuery; TPage: Page<AlatKerjaQuery>; TReq: AlatKerjaPostRequest; TList: AlatKerjaQuery[] };
}
