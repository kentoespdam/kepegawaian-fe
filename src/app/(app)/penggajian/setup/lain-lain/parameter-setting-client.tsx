...
const BASE = "/penggajian/setup/lain-lain";

export function ParameterSettingClient() {
	const cfg = parameterSettingConfig;
	...
	const [editing, setEditing] = useState<GajiParameterSettingResponse | null>(null);
	...
	const openEdit = (item: Record<string, unknown>) => {
		setEditing(item as GajiParameterSettingResponse);
		setError(null);
		setDialogOpen(true);
	};
