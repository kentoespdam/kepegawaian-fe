...
import { getStepState, STEPS } from "./_lib/step-state";
...
export function BatchLayoutClient({ batchId, children }: { batchId: string; children: React.ReactNode }) {
	const { data: batch, isPending, isError } = useBatchInfo(batchId);

	return (
		<BatchProvider value={{ data: batch, isPending, isError, error: null }}>
