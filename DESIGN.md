...
`docs/context/<modul>.md` (delta), `docs/design/color-rationale.md`, dan ADR di `docs/adr/`. **Tidak ada
nilai karangan.**
...
- `docs/design/color-rationale.md` — justifikasi WCAG/mata-lansia untuk tiap nilai OKLCH.
