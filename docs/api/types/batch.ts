...
export interface BatchSearchParams extends PageQuery {
  periode?: string;
  status?: "PENDING" | "PROSES" | "WAIT_VERIFICATION_PHASE_1" | "WAIT_VERIFICATION_PHASE_2" | "WAIT_APPROVAL" | "FINISHED" | "FAILED";
  ltStatus?: string;
  gtStatus?: string;
