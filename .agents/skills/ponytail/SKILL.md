...
Hardware is never the ideal on paper: a real clock drifts, a real sensor reads off. Leave the calibration knob. The physical world needs tuning a minimal model can't see.
